...
public class RoomListActivity extends AppCompatActivity {
    ...
    private ArrayList<RoomModel> loadRoomsFromDB() {
        ...
        String[] projection = {
                ...
                DBContract.RoomEntry.Room_NAME
        };

        Cursor cursor = db.query(
                DBContract.RoomEntry.TABLE_NAMES,
                projection,
        ...
        while (cursor.moveToNext()) {
            ...
            String name = cursor.getString(cursor.getColumnIndexOrThrow(DBContract.RoomEntry.Room_NAME));
